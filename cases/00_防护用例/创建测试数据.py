...
def create_config_file():
    ...
    ppt_headers = [
        ...
        "图表类型", "数据Sheet", "X轴", "Y轴",
        "图表标题", "颜色", "备注", "结论模板", "数据源",
        "HTML生成", "HTML图表类型", "文字内容"
    ]

    # PPT页面（11页，覆盖所有布局/图表类型/新页面类型）
    ppt_rows = [
        # 页1: 封面
        [1, "封面", "销售数据分析报告\n防护用例", "基础防护测试 | 全特性覆盖", "",
         "", "", "", "",
        ...
        # 页7: 左图右文 + 文字内容（P0补全：文字区渲染）
        [7, "内容", "分析结论与说明", "", "左图右文",
         "", "", "", "",
         "", "", "本报告由防护用例自动生成", "", "",
         "否", "", "本报告基于测试数据生成，覆盖以下特性：\n1. 透视分析（分组、交叉表、占比、分箱）\n2. 多种图表类型（柱状图、饼图、折线图）\n3. 配置化PPT生成\n4. 结论模板自动填充\n5. 目录/章节/结尾页\n6. X轴长标签自动旋转"],

        # 页8: block合并测试
        [8, "内容", "block合并测试", "", "1图",
         "column", "block合并测试", "销售额区间", "客户数_A",
         "block合并测试(列A)", "auto", "", "验证行维度不同+映射相同=合并区块", "透视结果",
         "是", "", ""],
        ...
        # 页10: 长标签测试（P1新增，8个城市>6触发X轴旋转）
        [10, "内容", "城市销售长标签测试", "", "1图",
         "column", "城市销售", "城市", "销售额",
         "各城市销售额对比", "auto", "", "销售额最高城市: {max_cat} ({max_val})", "测试数据.xlsx",
         "是", "bar", ""],
